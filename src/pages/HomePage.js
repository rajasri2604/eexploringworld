    ...
    <div className="p-0">
      ...
      <section className="my-12 px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {destinations.map((place, i) => (
            <div
              key={i}
              className="bg-white rounded-lg shadow-lg transform transition hover:scale-105 overflow-hidden"
            >
      ...
      {showBooking && (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded shadow-lg w-full max-w-md relative animate__animated animate__fadeIn">
